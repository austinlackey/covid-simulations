...
* Performed the function on Italy data to predict the potential number of cases.
* Performed the Monte Carlo Simulations to predict the day in which the peak of the number of daily cases in Italy occurs.
