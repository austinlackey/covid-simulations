...
## Ciufolini and Paolozzi's Study
...
ggplot(data = china) +
  ...
  geom_segment(aes(x = peak1, y = 0, xend = peak1, yend = china$total_cases[ceiling(peak1)]))
```
...
ggplot(data = china) +
  ...
  geom_segment(aes(x = peak2, y = 0, xend = peak2, yend = china$total_deaths[ceiling(peak2)]))
```
