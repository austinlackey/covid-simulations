...
* The number of cumulative diagnosed positive cases and fatalities in China approximates a gauss error function:  
$a+b*erf(c*x-d)$.
* Used the function to approximate the number of cumulative positive cases in Italy
* Performed a 150 Monte Carlo simulations to predict the day in which the peak of the number of daily cases in Italy occurs.
...
ggplot(italy, aes(x = days, y = total_cases)) + 
    geom_point() + 
    stat_function(fun=cf_italy, color="#d33636", size=2, linetype="solid") +
...
ggplot(italy, aes(x = days, y = total_deaths)) +
    geom_point() + 
    stat_function(fun=df_italy, color="#1b95ff", size=2, linetype="solid") +
    scale_x_continuous(breaks = seq(0, 67, 10)) +
    labs(title = "Total Deaths in Italy from 2/15/2020 to 3/29/2020 (44 days)", x = "Days", y = "Total Deaths")
```
...
## 150 Monte Carlo simulations plotted
...
```{r, results=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
ggplot() +
  geom_point(aes(x=1:m, y=flex_ca), color="red") +
  geom_hline(yintercept=mean(flex_ca), color="blue") +
...
ggplot(italy, aes(x = days, y = total_cases)) + 
    ...
    scale_x_continuous(breaks = seq(0, 67, 10)) +
    labs(title = "Total Cases in Italy from 2/15/2020 to 3/29/2020 (44 days)", x = "Days", y = "Total Cases") + 
  geom_vline(xintercept = mean(flex_ca), color="#d33636", size=1.5, linetype="dashed")
```
...
ggplot(italy, aes(x = days, y = total_deaths)) +
    ...
    scale_x_continuous(breaks = seq(0, 67, 10)) +
    labs(title = "Total Deaths in Italy from 2/15/2020 to 3/29/2020 (44 days)", x = "Days", y = "Total Deaths") +
  geom_vline(xintercept = mean(flex_fa), color="#1b95ff", size=1.5, linetype="dashed")
```
...
## Applying the function to the future cases dataset
...
## Applying the function to the future fatalities dataset
