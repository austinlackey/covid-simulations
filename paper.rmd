...
positive <- ggplot(data = china) +
  ...
  labs(title = "Figure 1: Total Cases in China from 1/22/2020 to 3/27/2020",
...
ggplot(data = china) +
  ...
  theme(title =element_text(size=6)) +
  labs(title = "Figure 2: Total Deaths in China from 1/22/2020 to 3/27/2020",
...
ggplot(data = china) +
  ...
  theme(title =element_text(size=6)) +
  labs(title = "Figure 3: Total Cases in China with Gauss Error Function",
...
ggplot(data = china) +
  ...
  theme(title =element_text(size=6)) +
  labs(title = "Figure 4: Total Deaths in China with Gauss Error Function",
